...
ObjectsToClean = [580 606 613 627 638 655 663 676 1039 1630 1663 1686 1690 1693 1709 1712 1726 ...
    ...
    3391 3397 3478 3486 3498 3502 3506 3510 3514 3524 3526 3534 3540 3542 3546 3547 3556 3561 3566 3571 3576 3588 3593 ...
    3602 3623 3624 3628 3632  ...
    5077 5219 5221 5225 5231 5457 5489 5495 5501 5548 5553 5683 5687 5711 5716 5721 5726 5771 5775 5779 5780 5823 5828 ...
    ...
    8058 8136 8240 8257 8276 8532 8537 8542 8361 8662 8692 8696 8700 8703 8733 8737 8741 8781 8787 8832 8840 8836 8846 8917 ...
    9443 9446 ...
    10097 10102 10723 10728 10742 10747 10752 ...
    10873 10879 ...
    10967 ...
    11093 11174 11180 11207 11308 11541 11576 11578 11583 11588 11593 11598 11604 11606 11609 11614 11619 11624 11629 11663 11671 11678 ...
...
currentLane_tilt    = currentLane(:,3)+tilt*currentLane(:,1);
X0                  = [currentLane(:,3),currentLane_tilt(:,1)];
Z0                  = linkage(X0,'single');
T0                  = cluster(Z0,'cutoff',1.1,'criterion','distance');
...
orderT0             = unique(T0,'stable');
numLabels           = numel(orderT0);
[q1,q2]             = hist(T0,1:numLabels);
%labelsToRemove      = q2(q1<5);

  
%T0(ismember(T0,labelsToRemove))=nan;

T1                  = zeros(size(T0));
%newLabel = 1;
for k=1:numLabels
  %  if (sum(T0==orderT0(k))>0)
        T1(T0==orderT0(k)) = k;
  %              T1(T0==orderT0(k)) = newLabel;
  %      newLabel = newLabel+1;
  %  end
end
